...
class Podcast extends Component {
    ...
    render() {
        ...
        const introBlurb = "The first episode of the Esports History Podcast that covers the entire history of esports. This is a great introduction to the world of esports and we highly recommend starting here.";
        ...
        return (
            <section>
                ...
                <Card image={logo} alt="esports history logo" title="The Entire History of Esports in Brief" blurb={this.introBlurb} />
                <Card image={finalBossImage} alt="final boss holding a check after winning the 2007 national championship in halo 2" title="Final Boss - A Halo Dynasty" blurb={this.finalBossBlurb} />
                <Card image={twinGalaxiesImage} alt="twin galaxies international scoreboard with many world record holders in the foreground" title="Twin Galaxies - An Esports Origin Story" blurb={this.twinGalaxiesBlurb} />
            </section>
        )
    }
}
